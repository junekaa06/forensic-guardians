...
export class PersonalInfo8 extends Component{
                            ...
                            <div className="ChestFeatures">
                                ...
                                <div className="grid-container_3">
                                    ...
                                    <div className="center">
                                        <img style={{width: 300, height: 400}} src={require("../src/chest_front.jpg")} alt="Chest"/>
                                    </div>
