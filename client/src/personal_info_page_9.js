...
export class PersonalInfo9 extends Component{
    ...
    callSubmit() {
        if (this.state.feature !== '' && this.state.side !== '' && this.state.description !== '') {
            fetch("http://localhost:9000/addBodyFeature?medicaltype="
                ...
                + this.state.feature
                + "&place="
                + this.state.side + " side of Left Leg", {
                        ...
                        <div className="basicpage">
                            ...
                            <div className="LeftLegFeatures">
                                ...
                                <div className="grid-container_3">
                                    ...
                                    <div class="center">
                                        <img style={{width: 300, height: 600}} src={require("../src/left_leg_full.jpg")} alt="Chest"/>
                                    </div>
