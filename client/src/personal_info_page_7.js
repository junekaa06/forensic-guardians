...
export class PersonalInfo7 extends Component{
    ...
    callSubmit() {
        if (this.state.feature !== '' && this.state.side !== '' && this.state.description !== '') {
            fetch("http://localhost:9000/addBodyFeature?medicaltype="
                ...
                + this.state.feature
                + "&place="
                + this.state.side + " side of Right Arm", {
                        ...
                        <div className="basicpage">
                            ...
                            <div className="ArmFeatures">
                                ...
                                <div className="grid-container_3">
                                    <div>
                                        ...
                                        <div>
                                            <div class="padding-left3">
                                                ...
                                                <TextField id="filled-basic" placeholder="Description" variant="filled" multiline fullWidth="5%" name="description" value={this.state.description} onChange={this.handleChange}/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div>
                                    ...
                                    <div class="center">
                                        <img style={{width: 300, height: 600}} src={require("../src/left_arm_full.jpg")} alt="Arm"/>
                                    </div>
