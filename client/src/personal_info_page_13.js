...
export class PersonalInfo13 extends Component{
    constructor(props) {
        super(props);
    ...
    callSubmit() {
        if (this.state.feature !== '' && this.state.side !== '' && this.state.description !== '') {
            fetch("http://localhost:9000/addBodyFeature?medicaltype="
                ...
                + this.state.feature
                + "&place="
                + this.state.side + " side of Back of the Head", {
                        ...
                        <div className="basicpage">
                            ...
                            <div className="FrontHeadFeatures">
                                ...
                                <div className="grid-container_3">
                                    ...
                                    <div class="center">
                                        <img style={{width: 300, height: 300}} src={require("../src/back_head.jpg")} alt="Chest"/>
                                    </div>
