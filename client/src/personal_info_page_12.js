...
export class PersonalInfo12 extends Component{
    ...
    callSubmit() {
        if (this.state.feature !== '' && this.state.side !== '' && this.state.description !== '') {
            fetch("http://localhost:9000/addBodyFeature?medicaltype="
                ...
                + this.state.feature
                + "&place="
                + this.state.side + " side of Front of the Head", {
                ...
                <Switch>
                    <Route exact path="/personal_info_12">
                        <div className="basicpage">
                            ...
                            <hr/>
                            <div className="FrontHeadFeatures">
                                ...
                                <div className="grid-container_3">
                                    ...
                                    <div class="center">
                                        <img style={{width: 300, height: 300}} src={require("../src/front_head.jpg")} alt="Chest"/>
                                    </div>
