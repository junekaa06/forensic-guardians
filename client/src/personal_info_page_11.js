...
export class PersonalInfo11 extends Component{
    ...
    callSubmit() {
        if (this.state.feature !== '' && this.state.side !== '' && this.state.description !== '') {
            fetch("http://localhost:9000/addBodyFeature?medicaltype="
                ...
                + this.state.feature
                + "&place="
                + this.state.side + " side of Right Leg", {
                ...
                <Switch>
                    <Route exact path="/personal_info_11">
                        <div className="basicpage">
                            ...
                            <hr/>
                            <div className="RightLegFeatures">
                                ...
                                <div className="grid-container_3">
                                    ...
                                    <div className="center">
                                        <img style={{width: 300, height: 600}} src={require("../src/right_leg_full.jpg")} alt="Chest"/>
                                    </div>
